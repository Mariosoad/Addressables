...
{
    [SerializeField] bool m_ShowNotTrackingReasons = true;

    [SerializeField] string InitRelocalText = "Initializing augmented reality.";

    [SerializeField] string MotionText = "Try moving at a slower pace.";

    [SerializeField] string LightText = "It’s too dark. Try going to a more well lit area.";

    [SerializeField] string FeaturesText = "Look for more textures or details in the area.";

    [SerializeField] string UnsupportedText = "AR content is not supported.";

    [SerializeField] string NoneText = "Wait for tracking to begin.";
    ...
    [SerializeField] TMP_Text m_ReasonDisplayText;
    ...
    [SerializeField] GameObject m_ReasonParent;
    ...
    [SerializeField] Image m_ReasonIcon;
    ...
    [SerializeField] Sprite m_InitRelocalSprite;
    ...
    [SerializeField] Sprite m_MotionSprite;
    ...
    [SerializeField] Sprite m_LightSprite;
    ...
    [SerializeField] Sprite m_FeaturesSprite;
    ...
    [SerializeField] Sprite m_UnsupportedSprite;
