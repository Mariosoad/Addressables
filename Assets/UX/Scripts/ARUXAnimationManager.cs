...
public class ARUXAnimationManager : MonoBehaviour
{
    ...
    [SerializeField]
    string MoveDeviceText = "Move Device Slowly";

    [SerializeField]
    string TapToPlaceText = "Tap to Place AR";

    [SerializeField]
    string FindABodyText = "Find a Body to Track";

    [SerializeField]
    string FindAFaceText = "Find a Face to Track";

    [SerializeField]
    string FindClipText = "Find an Image to Track";

    [SerializeField]
    string FindObjectText = "Find an Object to Track";
    ...
    public void ShowTapToPlace()
    {
        ...
        m_VideoPlayer.Play();
        m_InstructionText.text = TapToPlaceText;
    ...
    public void ShowFindImage()
    {
        ...
        m_VideoPlayer.Play();
        m_InstructionText.text = FindClipText;
    ...
    public void ShowFindBody()
    {
        ...
        m_VideoPlayer.Play();
         m_InstructionText.text = FindABodyText;
    ...
    public void ShowFindObject()
    {
        ...
        m_VideoPlayer.Play();
        m_InstructionText.text = FindObjectText;
    ...
    public void ShowFindFace()
    {
        ...
        m_VideoPlayer.Play();
        m_InstructionText.text = FindAFaceText;
    ...
    public void ShowCrossPlatformFindAPlane()
    {
        ...
        m_VideoPlayer.Play();
        m_InstructionText.text = MoveDeviceText;
